...
use jni::sys::{JavaVM, jint, jmethodID, JNIEnv, jvalue};
...
pub type jnihook_callback_t = ::std::option::Option<
    unsafe extern "C" fn(
        jni: *mut JNIEnv,
        callableMethod: jmethodID,
        args: *mut jvalue,
        nargs: usize,
...
extern "C" {
    pub fn JNIHook_Init(jvm: *mut JavaVM) -> jint;
}
extern "C" {
    pub fn JNIHook_Attach(
        mID: jmethodID,
        callback: jnihook_callback_t,
        arg: *mut ::std::os::raw::c_void,
    ) -> jint;
}
extern "C" {
    pub fn JNIHook_Detach(mID: jmethodID) -> jint;
}
extern "C" {
    pub fn JNIHook_Shutdown() -> jint;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
